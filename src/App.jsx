...
export default function App() {
  ...
  // Handle browser back button — pop state returns to professor list
  useEffect(() => {
      ...
      >
        ...
        >
          <div
            ...
            onClick={() => {
              if (selectedProf) window.history.back();
              else setSelectedProf(null);
            }}
          >
            <div
              style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              {filtered.map((p) => (
                <ProfCard
                  ...
                  onClick={() => {
                    window.history.pushState({ prof: p.id }, "");
                    setSelectedProf(p);
                  }}
                  t={t}
                />
